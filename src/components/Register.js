  ...
  return (
    <>
      <section className="text-center text-lg-start">
              ...
              <div className="card cascading-right">
                <div className="card-body p-5 shadow-5 text-center">
                  ...
                  <div className="form-outline mb-4">
                    ...
                    <Link to="/Posts">
                      {" "}
                      <button className="btn btn-secondary">View As Guest</button>
                    </Link>
                    </div>
                  </form>
                </div>
        ...
        <img src="https://static.boredpanda.com/blog/wp-content/uploads/2017/04/Mountain-Lilac-4-s-58e94fe9e501a__880.jpg" className="w-100 rounded-4 shadow-4"
          alt="" />
      </div>
          </div>
        </div>
